            ...
            <form id="formEditarUsuario" name="formEditarUsuario" class="form-horizontal" method="POST" action="{{ url('/editUser') }}">
                <div class="controls">
                    ...
                    <div class="modal-header modal_header_socios">
                        <h4 class="modal-title modal_title_socios">{{ trans('zona_socio.editarUsuario_titulo') }}</h4>
                    ...
                    <div class="modal-body modal_body_socios modal_widthLg">
                        <div class="row" style="margin-bottom: 15px;">
                            ...
                            <div class="col-8">
                                ...
                                <input type="text" style="width: 100%;" name="usuario_nombre" id="usuario_nombre" value="{{ $user->name }}" required />
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-4">
