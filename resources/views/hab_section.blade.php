    ...
    <div class="container">
        ...
        <div class="row ficha">
            <div class="hab-description">
                ...
                <div class="hab">
                    <button onclick="location.href='{{ url('/reserva/' . 0 ) }}'" type="button">{{ trans('habitaciones.reservarBtn') }}</button>
        ...
        <div class="row ficha">
            <div class="hab-description dcha-description">
                ...
                <div class="hab">
                    <button onclick="location.href='{{ url('/reserva/' . 1 ) }}'" type="button">{{ trans('habitaciones.reservarBtn') }}</button>
        ...
        <div class="row ficha">
            <div class="hab-description">
                ...
                <div class="hab">
                    <button onclick="location.href='{{ url('/reserva/' . 2 ) }}'" type="button">{{ trans('habitaciones.reservarBtn') }}</button>
        ...
        <div class="row ficha">
            <div class="hab-description dcha-description">
                ...
                <div class="hab">
                    <button onclick="location.href='{{ url('/reserva/' . 3 ) }}'" type="button">{{ trans('habitaciones.reservarBtn') }}</button>
        ...
        <div class="row ficha">
            <div class="hab-description">
                ...
                <div class="hab">
                    <button onclick="location.href='{{ url('/reserva/' . 4 ) }}'" type="button">{{ trans('habitaciones.reservarBtn') }}</button>
