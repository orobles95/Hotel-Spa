    ...
    <div class="container hotel_sections_container" >
        <div  class="row hotel_sections_row">
            <div class="col-3">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.aguasTermales') }}</b></h6>
                </div>
            </div>
            <div class="col-3">
                <div class="align-self-center main_col div_center_content hotel_section_div_img">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.navidad') }}</b></h6>
                </div>
            </div>
            <div class="col-3">
                <div class="align-self-center main_col div_center_content hotel_section_div_img">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.gastronomia') }}</b></h6>
                </div>
            </div>
            <div class="col-3">
                <div class="align-self-center main_col div_center_content hotel_section_div_img">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.salud') }}</b></h6>
                </div>
            </div>
        ...
        <div  class="row hotel_sections_row">
            <div class="col-3">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.belleza') }}</b></h6>
                </div>
            </div>
            <div class="col-3">
                <div class="align-self-center main_col div_center_content hotel_section_div_img">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.meditacion') }}</b></h6>
                </div>
            </div>
            <div class="col-3">
                <div class="align-self-center main_col div_center_content hotel_section_div_img">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.corporal') }}</b></h6>
                </div>
            </div>
            <div class="col-3">
                <div class="align-self-center main_col div_center_content hotel_section_div_img">
                ...
                <div class="align-self-center main_col hotel_section_div_title">
                    <h6 class="hotel_sections_titulo"><b>{{ trans('hotel_sections.zonaKids') }}</b></h6>
                </div>
            </div>
        </div>
    </div>
