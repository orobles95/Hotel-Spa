...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2018 a las 11:21:50
...
(1, 'UserAdmin', 'admin@hotelspa.com', 'Administrador_BBDD', '$2y$10$DZ.nIS.98xOJn2yG6PO1OOvwu.06mQ2JjSHO5KxKIuH6a37ZYTkpW', 'M9tf84jrcYt1FX1EujS28fumYTOOsqnMnnBybQ8yI9iptGUiFEEy0Der8r7Q', '2018-05-30 15:34:46', '2018-05-30 15:34:46');
...
CREATE TABLE `reservas` (
  ...
  `secretNumber_card` varchar(3) NOT NULL,
...
INSERT INTO `reservas` (`id`, `client_email`, `card_number`, `holder_card`, `secretNumber_card`, `expDate_card`, `room`, `fechaentrada`, `fechasalida`, `huespedes`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `reservasrestaurants` (`id`, `client_email`, `card_number`, `holder_card`, `secretNumber_card`, `expDate_card`, `restaurant`, `fechaentrada`, `comensales`, `hora`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `reservasspas` (`id`, `client_email`, `card_number`, `holder_card`, `secretNumber_card`, `expDate_card`, `spa`, `fechaentrada`, `personas`, `hora`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `reservastratamientos` (`id`, `client_email`, `card_number`, `holder_card`, `secretNumber_card`, `expDate_card`, `tratamiento`, `fechaentrada`, `hora`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `users` (
  ...
  `secretNumber_card` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `card_number`, `holder_card`, `secretNumber_card`, `expDate_card`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(6, 'no', '1234567890123456', '', '', '', 'k@k.com', '$2y$10$UD6TMqbR.B9SrvQofPNe7./eWp/gwYmDOrpmbsp41kXKuBrx9ChS2', 'IqFgm86b6o8BQFxEqSRuOuTt5LhK6uaY6FhrslCsbYz9SImAdU0x8CoqYbSE', '2018-05-30 08:11:25', '2018-05-30 10:04:26');
